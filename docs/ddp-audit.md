...
Generated: 2026-05-22T19:21:48.592Z
...
| `getRoomByTypeAndName` | apps/meteor/server/publications/room/index.ts:58 | 2 | — none — |
...
| `UserPresence:away` | apps/meteor/server/methods/userPresence.ts:36 | 1 | — none — |
| `UserPresence:online` | apps/meteor/server/methods/userPresence.ts:29 | 1 | — none — |
...
| `cloud:connectWorkspace` | apps/meteor/app/cloud/server/methods.ts:119 | 1 | — none — |
| `cloud:getWorkspaceRegisterData` | apps/meteor/app/cloud/server/methods.ts:61 | 1 | — none — |
| `cloud:syncWorkspace` | apps/meteor/app/cloud/server/methods.ts:99 | 1 | `cloud.syncWorkspace` |
...
| `license:getModules` | apps/meteor/ee/app/license/server/methods.ts:29 | 1 | `licenses.info` |
| `license:isEnterprise` | apps/meteor/ee/app/license/server/methods.ts:39 | 1 | — none — |
...
| method | registration |
|---|---|
| `OAuth.retrieveCredential` | apps/meteor/app/iframe-login/server/iframe_server.ts:39 |
| `OEmbedCacheCleanup` | apps/meteor/server/methods/OEmbedCacheCleanup.ts:27 |
| `UserPresence:setDefaultStatus` | apps/meteor/server/methods/userPresence.ts:21 |
| `addAllUserToRoom` | apps/meteor/server/methods/addAllUserToRoom.ts:91 |
| `addIncomingIntegration` | apps/meteor/app/integrations/server/methods/incoming/addIncomingIntegration.ts:181 |
| `addOutgoingIntegration` | apps/meteor/app/integrations/server/methods/outgoing/addOutgoingIntegration.ts:81 |
| `addRoomLeader` | apps/meteor/server/methods/addRoomLeader.ts:94 |
| `addRoomModerator` | apps/meteor/server/methods/addRoomModerator.ts:116 |
| `addRoomOwner` | apps/meteor/server/methods/addRoomOwner.ts:113 |
| `addSamlService` | apps/meteor/app/meteor-accounts-saml/server/methods/addSamlService.ts:18 |
| `addUserToRoom` | apps/meteor/app/lib/server/methods/addUserToRoom.ts:18 |
| `addWebdavAccountByToken` | apps/meteor/app/webdav/server/methods/addWebdavAccount.ts:148 |
| `archiveRoom` | apps/meteor/app/lib/server/methods/archiveRoom.ts:48 |
| `autoTranslate.saveSettings` | apps/meteor/app/autotranslate/server/methods/saveSettings.ts:18 |
| `blockUser` | apps/meteor/app/lib/server/methods/blockUser.ts:22 |
| `botRequest` | apps/meteor/app/bot-helpers/server/index.ts:211 |
| `browseChannels` | apps/meteor/server/methods/browseChannels.ts:352 |
| `channelsList` | apps/meteor/server/methods/channelsList.ts:26 |
| `checkFederationConfiguration` | apps/meteor/app/lib/server/methods/checkFederationConfiguration.ts:19 |
| `cleanRoomHistory` | apps/meteor/app/lib/server/methods/cleanRoomHistory.ts:73 |
| `cloud:checkRegisterStatus` | apps/meteor/app/cloud/server/methods.ts:43 |
| `cloud:checkUserLoggedIn` | apps/meteor/app/cloud/server/methods.ts:192 |
| `cloud:finishOAuthAuthorization` | apps/meteor/app/cloud/server/methods.ts:168 |
| `cloud:getOAuthAuthorizationUrl` | apps/meteor/app/cloud/server/methods.ts:148 |
| `cloud:logout` | apps/meteor/app/cloud/server/methods.ts:212 |
| `cloud:registerWorkspace` | apps/meteor/app/cloud/server/methods.ts:81 |
| `createChannel` | apps/meteor/app/lib/server/methods/createChannel.ts:66 |
| `createDiscussion` | apps/meteor/app/discussion/server/methods/createDiscussion.ts:253 |
| `crowd_sync_users` | apps/meteor/app/crowd/server/methods.ts:61 |
| `crowd_test_connection` | apps/meteor/app/crowd/server/methods.ts:23 |
| `deleteCustomUserStatus` | apps/meteor/app/user-status/server/methods/deleteCustomUserStatus.ts:36 |
| `deleteEmojiCustom` | apps/meteor/app/emoji-custom/server/methods/deleteEmojiCustom.ts:41 |
| `deleteIncomingIntegration` | apps/meteor/app/integrations/server/methods/incoming/deleteIncomingIntegration.ts:46 |
| `deleteOAuthApp` | apps/meteor/app/oauth2-server-config/server/admin/methods/deleteOAuthApp.ts:40 |
| `deleteOutgoingIntegration` | apps/meteor/app/integrations/server/methods/outgoing/deleteOutgoingIntegration.ts:54 |
| `deleteUser` | apps/meteor/server/methods/deleteUser.ts:52 |
| `deleteUserOwnAccount` | apps/meteor/app/lib/server/methods/deleteUserOwnAccount.ts:69 |
| `downloadPublicImportFile` | apps/meteor/app/importer/server/methods/downloadPublicImportFile.ts:90 |
| `e2e.fetchMyKeys` | apps/meteor/app/e2e/server/methods/fetchMyKeys.ts:18 |
| `e2e.setUserPublicAndPrivateKeys` | apps/meteor/app/e2e/server/methods/setUserPublicAndPrivateKeys.ts:48 |
| `followMessage` | apps/meteor/app/threads/server/methods/followMessage.ts:56 |
| `getChannelHistory` | apps/meteor/app/lib/server/methods/getChannelHistory.ts:161 |
| `getImportFileData` | apps/meteor/app/importer/server/methods/getImportFileData.ts:77 |
| `getImportProgress` | apps/meteor/app/importer/server/methods/getImportProgress.ts:38 |
| `getLatestImportOperations` | apps/meteor/app/importer/server/methods/getLatestImportOperations.ts:32 |
| `getRoomIdByNameOrId` | apps/meteor/server/methods/getRoomIdByNameOrId.ts:21 |
| `getRoomJoinCode` | apps/meteor/app/lib/server/methods/getRoomJoinCode.ts:18 |
| `getRoomNameById` | apps/meteor/server/methods/getRoomNameById.ts:21 |
| `getS3FileUrl` | apps/meteor/app/file-upload/server/methods/getS3FileUrl.ts:22 |
| `getStatistics` | apps/meteor/app/statistics/server/methods/getStatistics.ts:19 |
| `getThreadsList` | apps/meteor/app/threads/server/methods/getThreadsList.ts:23 |
| `getTotalChannels` | apps/meteor/server/methods/getTotalChannels.ts:18 |
| `getUserMentionsByChannel` | apps/meteor/app/mentions/server/methods/getUserMentionsByChannel.ts:44 |
| `getUserStatusText` | apps/meteor/app/user-status/server/methods/getUserStatusText.ts:18 |
| `getUsernameSuggestion` | apps/meteor/app/lib/server/methods/getUsernameSuggestion.ts:18 |
| `getUsersOfRoom` | apps/meteor/server/methods/getUsersOfRoom.ts:32 |
| `hideRoom` | apps/meteor/server/methods/hideRoom.ts:38 |
| `ignoreUser` | apps/meteor/server/methods/ignoreUser.ts:50 |
| `insertOrUpdateEmoji` | apps/meteor/app/emoji-custom/server/methods/insertOrUpdateEmoji.ts:26 |
| `insertOrUpdateSound` | apps/meteor/app/custom-sounds/server/methods/insertOrUpdateSound.ts:33 |
| `insertOrUpdateUserStatus` | apps/meteor/app/user-status/server/methods/insertOrUpdateUserStatus.ts:110 |
| `joinDefaultChannels` | apps/meteor/app/lib/server/methods/joinDefaultChannels.ts:20 |
| `license:getTags` | apps/meteor/ee/app/license/server/methods.ts:35 |
| `license:hasLicense` | apps/meteor/ee/app/license/server/methods.ts:23 |
| `loadLocale` | apps/meteor/server/methods/loadLocale.ts:19 |
| `messageSearch` | apps/meteor/server/methods/messageSearch.ts:93 |
| `messages/get` | apps/meteor/server/publications/messages.ts:280 |
| `openRoom` | apps/meteor/server/methods/openRoom.ts:20 |
| `permissions/get` | apps/meteor/app/authorization/server/streamer/permissions/index.ts:38 |
| `pinMessage` | apps/meteor/app/message-pin/server/pinMessage.ts:204 |
| `private-settings/get` | apps/meteor/server/publications/settings/index.ts:62 |
| `public-settings/get` | apps/meteor/server/publications/settings/index.ts:28 |
| `push_test` | apps/meteor/server/lib/pushConfig.ts:44 |
| `raix:push-update` | apps/meteor/app/push/server/methods.ts:33 |
| `readMessages` | apps/meteor/server/methods/readMessages.ts:22 |
| `removeRoomLeader` | apps/meteor/server/methods/removeRoomLeader.ts:94 |
| `removeRoomModerator` | apps/meteor/server/methods/removeRoomModerator.ts:107 |
| `removeRoomOwner` | apps/meteor/server/methods/removeRoomOwner.ts:112 |
| `removeSlackBridgeChannelLinks` | apps/meteor/app/slackbridge/server/removeChannelLinks.ts:20 |
| `removeUserFromRoom` | apps/meteor/server/methods/removeUserFromRoom.ts:134 |
| `resetAvatar` | apps/meteor/server/methods/resetAvatar.ts:55 |
| `resetIrcConnection` | apps/meteor/app/irc/server/methods/resetIrcConnection.ts:23 |
| `restart_server` | apps/meteor/app/lib/server/methods/restartServer.ts:21 |
| `rocketchatSearch.suggest` | apps/meteor/app/search/server/methods.ts:78 |
| `rooms/get` | apps/meteor/server/publications/room/index.ts:53 |
| `samlLogout` | apps/meteor/app/meteor-accounts-saml/server/methods/samlLogout.ts:40 |
| `saveAudioNotificationValue` | apps/meteor/app/push-notifications/server/methods/saveNotificationSettings.ts:156 |
| `saveNotificationSettings` | apps/meteor/app/push-notifications/server/methods/saveNotificationSettings.ts:138 |
| `saveSetting` | apps/meteor/app/lib/server/methods/saveSetting.ts:26 |
| `saveUserPreferences` | apps/meteor/server/methods/saveUserPreferences.ts:227 |
| `sendFileMessage` | apps/meteor/app/file-upload/server/methods/sendFileMessage.ts:247 |
| `sendForgotPasswordEmail` | apps/meteor/server/methods/sendForgotPasswordEmail.ts:45 |
| `sendMessageLivechat` | apps/meteor/app/livechat/server/methods/sendMessageLivechat.ts:87 |
| `sendSMTPTestEmail` | apps/meteor/app/lib/server/methods/sendSMTPTestEmail.ts:23 |
| `setEmail` | apps/meteor/app/lib/server/methods/setEmail.ts:45 |
| `setRealName` | apps/meteor/app/lib/server/methods/setRealName.ts:21 |
| `setUserActiveStatus` | apps/meteor/server/methods/setUserActiveStatus.ts:40 |
| `starMessage` | apps/meteor/app/message-star/server/starMessage.ts:68 |
| `startImport` | apps/meteor/app/importer/server/methods/startImport.ts:39 |
| `toggleFavorite` | apps/meteor/server/methods/toggleFavorite.ts:36 |
| `unarchiveRoom` | apps/meteor/app/lib/server/methods/unarchiveRoom.ts:43 |
| `unblockUser` | apps/meteor/app/lib/server/methods/unblockUser.ts:20 |
| `unfollowMessage` | apps/meteor/app/threads/server/methods/unfollowMessage.ts:56 |
| `unpinMessage` | apps/meteor/app/message-pin/server/pinMessage.ts:220 |
| `unreadMessages` | apps/meteor/app/message-mark-as-unread/server/unreadMessages.ts:87 |
| `updateIncomingIntegration` | apps/meteor/app/integrations/server/methods/incoming/updateIncomingIntegration.ts:197 |
| `updateMessage` | apps/meteor/app/lib/server/methods/updateMessage.ts:106 |
| `updateOAuthApp` | apps/meteor/app/oauth2-server-config/server/admin/methods/updateOAuthApp.ts:83 |
| `updateOutgoingIntegration` | apps/meteor/app/integrations/server/methods/outgoing/updateOutgoingIntegration.ts:125 |
| `uploadCustomSound` | apps/meteor/app/custom-sounds/server/methods/uploadCustomSound.ts:21 |
| `uploadEmojiCustom` | apps/meteor/app/emoji-custom/server/methods/uploadEmojiCustom.ts:26 |
| `uploadImportFile` | apps/meteor/app/importer/server/methods/uploadImportFile.ts:70 |
...
| `UserPresence:away` | apps/meteor/server/methods/userPresence.ts:36 | 1 |
| `UserPresence:online` | apps/meteor/server/methods/userPresence.ts:29 | 1 |
...
| `cloud:connectWorkspace` | apps/meteor/app/cloud/server/methods.ts:119 | 1 |
...
| `getRoomByTypeAndName` | apps/meteor/server/publications/room/index.ts:58 | 2 |
...
| `license:isEnterprise` | apps/meteor/ee/app/license/server/methods.ts:39 | 1 |
